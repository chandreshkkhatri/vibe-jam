/**
 * Smoke Tests for Simple Blogging Platform API
 *
 * These are basic integration tests that verify the core happy path
 * functionality works end-to-end. Run these first for quick validation.
 *
 * Coverage: Basic CRUD operations for all main features
 * Runtime: ~1.5 seconds
 */
